      ...
      <div className="flex flex-col mb-[11px]">
        <div className="flex flex-col gap-[8px]">
          ...
          <div className="flex flex-col bg-[#FFF]" id='mypage-set1'>
            ...
            <SetBlock icon={<CalendarIcn color='#6C6C6C' />} title='캘린더' count={12} url='/user/mypage/calendar' />
          </div>
...
const UserPage = (props: { userId: string | number }) => {
  return (
    <div className="pt-[60px]">
      <div className="flex flex-col mb-[11px]">
        <div className="flex flex-col gap-[8px]">
          <div className="flex flex-row px-[16px] py-[18px] gap-[16px] bg-[#FFF]" id='userpage-profile'>
            <div className="relative w-[77px] h-[70px] rounded-full">
              <img src="/default_icon.svg" className="w-[70px] h-[70px] rounded-full" />
            </div>
            <div className="flex flex-col">
              <span className="font-semibold text-[18px] leading-[140%] text-black">USER</span>
              <span className="text-[14px] leading-[160%] text-gray3">bageul@naver.com</span>
              <span className="text-[14px] leading-[160%] text-gray3">바글이의 한마디</span>
            </div>
          </div>
          <div className="flex flex-col bg-[#FFF]" id='userpage-set1'>
            <div className="p-[16px] text-[14px] leading-[160%] font-semibold text-black">바글이의 정보</div>
