...
export function PartiSelect(props: { openParti: boolean; handleOpenParti: any; participants: number; setParticipants: any }) {
  return (
...
export function HeadSelect(props: { openHead: boolean; handleOpenHead: any; headCount: { from?: number, to?: number }; setHeadCount: any }) {
  return (
        ...
        <div className="flex flex-col mt-[8px] gap-[8px]">
          ...
          <div className="flex flex-row justify-between">
            <div className="flex flex-row justify-between border border-gray2 rounded-[8px] w-[180px] px-[16px] py-[5px]">
              ...
              <HeadNumberInput placeholder="1명" value={props.headCount.from || null} min={0}
                onInputChange={(event) => {
            ...
            <div className="flex flex-row justify-between border border-gray2 rounded-[8px] w-[180px] px-[16px] py-[5px]">
              ...
              <HeadNumberInput placeholder="10명" value={props.headCount.to || null} min={props.headCount.from}
                onInputChange={(event) => {
